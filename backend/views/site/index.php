...
/** @var $latestVideo \common\models\query\Videos */
/** @var $numberOfView integer */
/** @var $numberOfSubscribers integer */
/** @var $subscribers \common\models\query\Subscriber[] */

$this->title = 'Clonetube Backend';
?>
<div class="site-index d-flex">
    <div class="card m-2" style="width: 14rem;">
        <?php if ($latestVideo): ?>
            <div class="mb-3">
                <video class="ratio ratio-16x9"
            ...
            <div class="card-body">
                ...
                <a href="<?php echo \yii\helpers\Url::to(['/videos/update',
